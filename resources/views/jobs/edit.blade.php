        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <x-form-field class="w-full" fieldname="title" placeholder="Software Engineer"
                    ...
                    <x-form-field class="w-full" fieldname="salary"
                        label="Salary (e.g.,
                            $50,000)" placeholder="$50,000"
                        data="{{ $job->salary }}" required>
                        @error('salary')
                            <p class="text-red-500 text-xs mt-2">{{ $message }}</p>
                        @enderror
                    </x-form-field>

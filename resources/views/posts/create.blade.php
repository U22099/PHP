    ...
    <div class="max-w-xl mx-auto py-8">
        <form method="POST" action="{{ route('posts.store') }}" class="bg-white shadow-md rounded-lg p-6">
            ...
            <div class="mb-4">
                ...
                <div class="mt-2">
                    <input type="text" name="title" id="title" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="A catchy title for your post" value="{{ old('title') }}">
                </div>
                @error('title')

<x-layout>
    ...
    <div class="mt-8 flow-root">
        <div class="space-y-10 divide-y divide-gray-200">
            ...
            @forelse ($posts as $authorFirstName => $postsByAuthor)
                <div class="pt-8 first:pt-0"> {{-- Adds top padding, but removes for the first group --}}
                    <h2
                        class="text-2xl sm:text-3xl font-extrabold text-gray-900 mb-6 border-b-2 border-indigo-600 pb-2 inline-block">
                        Articles by {{ $authorFirstName }}
                    </h2>

                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"> {{-- Grid for posts within each author group --}}

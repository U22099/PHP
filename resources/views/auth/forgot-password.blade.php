    ...
    <form method="POST" action="/forget-password"
        ...
        <div class="space-y-4 w-full">
            <div class="w-full">
                ...
                <p class="mt-1 text-sm leading-6 text-gray-600">Enter your account's email below to get a password reset email.</p>
        ...
        <div class="mt-6 flex flex-col items-center justify-end w-full">
            <x-button type="submit" class="w-full justify-center">Get Reset Email</x-button>
        </div>

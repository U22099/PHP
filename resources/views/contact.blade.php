                    ...
                    <div class="flex justify-end">
                        <button type="submit"
                            ...
                            <svg class="ml-3 -mr-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                fill="currentColor">
                                <path
                                    d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l.607-.272a11.023 11.023 0 013.386 1.483 1 1 0 00.916 0 11.023 11.023 0 013.386-1.484l.607.272a1 1 0 001.169-1.409l-7-14z" />
                            </svg>
                        </button>
                    </div>
                </form>
            ...
            <div>
                ...
                <div class="space-y-6 text-gray-700 text-lg">
                    <div class="flex items-start">
                        <svg class="flex-shrink-0 h-7 w-7 text-indigo-600 mr-4" xmlns="http://www.w3.org/2000/svg"
